...
export default function RootLayout({
  ...
  return (
    <html lang="ko-kr">
      <body className={`${inter.className} flex flex-col font-sans text-black dark:text-white`}>
        <LayoutHeader />
        {children}
        <LayoutFooter />
      </body>
  ...
  return (
    ...
    >
      <Link href="/" className="font-serif text-sm italic hover:underline">
        <b className="text-2xl">A</b> <b className="text-2xl">S</b>taff <b className="text-2xl">F</b>lows{" "}
        <b className="text-2xl">R</b>ight
      </Link>
...
const LayoutFooter = (): React.ReactNode => {
  return (
    ...
    >
      ...
      <b className="dark:text-white">Jaeseong Jeong</b> Powered by <b className="dark:text-white">Next.js</b>
    </div>
  );
};
